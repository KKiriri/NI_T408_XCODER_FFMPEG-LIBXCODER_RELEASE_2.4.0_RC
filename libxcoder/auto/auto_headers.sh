...
if [ $XCODER_SIM = YES ]; then
    echo "#define XCODER_SIM_ENABLED" >> $XCODER_AUTO_HEADERS_H
else
    echo "#undef XCODER_SIM_ENABLED" >> $XCODER_AUTO_HEADERS_H
fi

if [ $XCODER_DUMP = YES ]; then
    echo "#define XCODER_DUMP_ENABLED" >> $XCODER_AUTO_HEADERS_H
else
    echo "#undef XCODER_DUMP_ENABLED" >> $XCODER_AUTO_HEADERS_H
fi
