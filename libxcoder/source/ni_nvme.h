...
#define CTL_OFFSET_IN_4K(op,sub,subtype)    (START_OFFSET_IN_4K+(((op)<<NI_OP_BIT_OFFSET) + ((sub)<<NI_SUB_BIT_OFFSET)+subtype))  // each (op,sub,subtype) has 4k bytes
#define RD_OFFSET_IN_4K                     (START_OFFSET_IN_4K + MBs_to_4k(128))
#define WR_OFFSET_IN_4K                     (RD_OFFSET_IN_4K +  MBs_to_4k(128))
#define HIGH_OFFSET_IN_4K(sid,instance)     ((((sid & 0x7FUL)<<1)|(instance))<<NI_INSTANCE_OFFSET)  // 1024MB
